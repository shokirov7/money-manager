    ...
    try {
      if (isAdmin === "admin") {
        if (user.username === "admin" && user.password === "123") {
          ...
          alert(
            "Siz admin nomidan kira olishingiz uchun sizda ruxsat yo'q !"
          );
        }
        ...
        // dispatch(getUserDetails(data)); // Вам нужно обрабатывать действия для получения дополнительных данных пользователя
      }

      // Сохранение введенных данных в локальное хранилище
      setItem("role", isAdmin);
    } catch (error) {
      console.log(error);
